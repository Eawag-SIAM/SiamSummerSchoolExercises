...
Given the prior and the likelihood from [Task 1.2](#prilik), code your
own elementary Markov Chain sampler and run it for a few thousand
iterations. You can find a description of the steps needed in such a
sampler [here](metropolis_procedure.pdf).
**Hints**: Understand and fill-in the block below.
```{r}
