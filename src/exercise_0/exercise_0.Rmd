...
With package [`Plots.jl`](https://docs.juliaplots.org/stable/)
provides basic plotting function such as `scatter` and `histogram`. For
densities plots and other more specialized plots look at [`StatsPlots.jl`](https://docs.juliaplots.org/latest/generated/statsplots/).
