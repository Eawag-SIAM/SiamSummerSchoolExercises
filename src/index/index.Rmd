...
computing, with a wide range of packages for an extensive array
...
**Python** is a versatile and widely-used programming language known for its readability and simplicity. It has a rich ecosystem of libraries and frameworks for various applications. Libraries for data handling are comparable to R (e.g., Pandas, NumPy) and deep learning frameworks such as PyTorch, JAX, TensorFlow are usually best integrated with Python. As an interpreted language, Python, like R, belongs to the slower languages (although Cython and Numba can often optimize performance-critical parts of the code).
...
2. If you do not have a favorite text editor, we recommend installing [RStudio](https://posit.co/download/rstudio-desktop/), the most
...
course. Check carefully for any error messages!
```r
...
2. If you do not have a favorite text editor, install
     ...
     Plugin](https://www.julia-vscode.org/) following these [instructions](https://www.julia-vscode.org/docs/dev/gettingstarted/#Installation-and-Configuration).
...
3. Optional: install packages for a better user experience. Packages
   ...
   - [BenchmarkTools.jl](https://github.com/JuliaCI/BenchmarkTools.jl). Measure
     the execution speed, very helpful if you care about fast code.

### Install packages used for the course

Julia has a built-in package manager that also handles environments
...
Python can be installed in many ways. For these exercises we used a `miniconda` installation.
...
https://github.com/scheidan/SiamSummerSchoolExercises/blob/main/data/exercise_data.zip?raw=true) and extract it to a convenient location. It
...
If models.py is not stored in the same directory as the scripts, one should change the working directory to the given location
...
These exercises may use additional software packages.

- [Thursday A](exercise_4.html): Inference for Hierarchical models
  with STAN and JAGS

- [Thursday B](exercise_5.html): Approximate Bayesian Computation
  (ABC)
