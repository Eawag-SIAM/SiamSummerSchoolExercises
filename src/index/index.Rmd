...
**Python** is a versatile and widely-used programming language known for its readability and simplicity. It has a rich ecosystem of libraries and frameworks for various applications. Libraries for data handling are comparable ot R (e.g., Pandas, NumPy) and deep learning learning frameworks such as Pytorch, Jax, Tensorflow are usually  best integrated with python. As an interpreted language, Python, like R, belongs to the slower languages (Cython and Numba that can optimize performance-critical parts of the code).
...
The packages required are defined in `environment.yml`. The file defines the conda environment `SummerSchoolExercises`. 
Download the it **XXXXhereXXX** the file and create the `SummerSchoolExercises` environment with
```
...
#### Julia
- [`models.jl`]("https://raw.githubusercontent.com/Eawag-SIAM/SiamSummerSchoolExercises/main/models/models.r"}
